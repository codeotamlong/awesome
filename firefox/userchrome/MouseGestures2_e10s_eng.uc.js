...
var ucjsMouseGestures = {
  ...
  commands :
      ...
      [
        ...
        ['', 'Session History Popup', function(){ ucjsMouseGestures_helper.sessionHistoryPopup(); } ],
        ['', 'Go to top of history', function(){ SessionStore.getSessionHistory(gBrowser.selectedTab, history => {gBrowser.gotoIndex(history.entries.length = 0)}); } ],
        ['', 'Go to end of history', function(){ SessionStore.getSessionHistory(gBrowser.selectedTab, history => {gBrowser.gotoIndex(history.entries.length - 1)}); } ],
        ['RLR', '>> Fast Forward', function(){ ucjsNavigation?.fastNavigationBackForward(1); } ],
        ['LRL', '>> Fast Rewind', function(){ ucjsNavigation?.fastNavigationBackForward(-1); } ],

        ['RULD', 'Move up one level', function(){ ucjsMouseGestures_helper.goUpperLevel(); } ],
        ['ULDR', 'Increment number and move', function(){ ucjsMouseGestures_helper.goNumericURL(+1); } ],
        ['DLUR', 'Decrement number and move', function(){ ucjsMouseGestures_helper.goNumericURL(-1); } ],
        ['RL', 'Go to link such as [Next]', function(){ ucjsNavigation?.advancedNavigateLink(1); } ],
        ['LR', 'Go to [Back] etc. link', function(){ ucjsNavigation?.advancedNavigateLink(-1); } ],

        ['UD', 'Reload', function(){ document.getElementById("Browser:Reload").doCommand(); } ],
        ['UDU', 'Reload (Skip cache)', function(){ document.getElementById("Browser:ReloadSkipCache").doCommand(); } ],
        ...
        ['', 'Stop', function(){ document.getElementById("Browser:Stop").doCommand(); } ],

        ['', 'Open link in Container Tab', function(){ ucjsMouseGestures_helper.openLinkInContainerTab(); } ],

        ['', 'Open all selected text links in tabs (search with default search engine if no links are found)', function(){ ucjsMouseGestures_helper.openURLsInSelection(); } ],
        ['*RDL', 'Open all links in selection in tabs', function(){ ucjsMouseGestures_helper.openSelectedLinksInTabs(); } ],
        ['*RUL', 'Open all passed links in tabs', function(){ ucjsMouseGestures_helper.openHoverLinksInTabs(); } ],
        ['', 'Open link in new tab', function(){ ucjsMouseGestures_helper.openURLs([ucjsMouseGestures._linkURL]); } ],

        ['', 'Save selected links', function(){ ucjsMouseGestures_helper.saveSelectedLinks(); } ],
        ['', 'Save links passed', function(){ ucjsMouseGestures_helper.saveHoverLinks(); } ],

        ['', 'Copy', function(){ ucjsMouseGestures_helper.copyText(ucjsMouseGestures._selectedTXT); } ],
        ['', 'Copy link passed', function(){ ucjsMouseGestures_helper.copyHoverLinks(); } ],
        ['', 'Copy selected link', function(){ ucjsMouseGestures_helper.copySelectedLinks(); } ],
        ...
        ['URL', 'Go back one tab to the last selected tab', function(){ ucjsNavigation_tabFocusManager?.advancedFocusTab(1); } ],
        ...
        ['', 'Close tabs (except pinned tabs)', function(){ if (!gBrowser.selectedTab.pinned) { document.getElementById("cmd_close").doCommand(); } } ],

        ['', 'Close all tabs on the left', function(){ ucjsMouseGestures_helper.closeMultipleTabs("left"); } ],
        ['', 'Close all tabs on the right', function(){ ucjsMouseGestures_helper.closeMultipleTabs("right"); } ],
        ['', 'Close all other tabs', function(){ gBrowser.removeAllTabsBut(gBrowser.selectedTab); } ],
        ['DRU', 'Restore closed tab', function(){ document.getElementById("History:UndoCloseTab").doCommand(); } ],
        /*['DRU', 'Restore closed tab (one by one)', function(){undoCloseTab(0); } ],*/
        ...
        ['', 'Maximize/Original size', function(){ window.windowState == 1 ? window.restore() : window.maximize(); } ],
        ...
        ['DRD', 'Search by selected text (search engine popup)', function(){ ucjsMouseGestures_helper.webSearchPopup(ucjsMouseGestures._selectedTXT || ucjsMouseGestures._linkTXT); } ],
        ...
        ['', 'CSS toggle', function(){ var styleDisabled = gPageStyleMenu._getStyleSheetInfo(gBrowser.selectedBrowser).authorStyleDisabled; if (styleDisabled) gPageStyleMenu.switchStyleSheet(""); else gPageStyleMenu.disableStyle(); } ],

        ['UDUD', 'Popup gesture command', function(){ ucjsMouseGestures_helper.commandsPopop(); } ],
        ['', 'Reboot', function(){ ucjsMouseGestures_helper.restart(); } ],

        ['', 'Bookmarks Sidebar', function(){ SidebarUI.toggle("viewBookmarksSidebar"); } ],
        ['', 'History Sidebar', function(){ SidebarUI.toggle("viewHistorySidebar"); } ],
        ...
        ['', 'Addon Manager', function(){ openTrustedLinkIn("about:addons", "tab", {inBackground: false, relatedToCurrent: true}); } ],
        ['', 'Troubleshooting information', function(){ openTrustedLinkIn("about:support", "tab", {inBackground: false, relatedToCurrent: true}); } ],
        ['', 'Settings (optional)', function(){ openTrustedLinkIn("about:preferences", "tab", {inBackground: false, relatedToCurrent: true}); } ],
